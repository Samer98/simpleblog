...
class EditProfileForm(UserChangeForm):
    ...
    # is_staff = forms.EmailField(widget=forms.CheckboxInput(attrs={'class': 'form-check'}))
...
class PasswordChangingForm(PasswordChangeForm):
    ...
    new_password2 = forms.CharField(max_length=255,widget=forms.PasswordInput(attrs={'class': 'form-control','type':'password'}),label="conformation Password")
